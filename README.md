...
Запуск программы
    ...
    Запустите WildberriesParser.exe
    При первом запуске потребуется активация (см. раздел Активация)
    Введите поисковый запрос (например: телефон, кроссовки)
    Укажите количество страниц (1-10)
    Дождитесь завершения парсинга
    Результат сохранится в папке output/
...
🖼️ Скриншоты
<details> <summary>📸 Нажмите чтобы посмотреть скриншоты</summary> <br>
Главное меню
...
Как получить ключ
    ...
    Скопируйте свой Hardware ID из программы
    Отправьте ID разработчику в Telegram
    Получите лицензионный ключ
    Введите ключ в программу
    Готово! Активация завершена ✅
...
🐛 Решение проблем
<details> <summary><b>❌ Ошибка "ChromeDriver version mismatch"</b></summary> Обновите Chrome до последней версии или укажите версию в коде:

Python

self.driver = uc.Chrome(options=options, version_main=145)

</details><details> <summary><b>❌ "Подозрительная активность" на сайте WB</b></summary>
...
</details><details> <summary><b>❌ Программа не находит товары</b></summary>
...
</details><details> <summary><b>❌ Неверный лицензионный ключ</b></summary>

    Проверьте что ключ для вашего Hardware ID
    Скопируйте ключ без пробелов
    Обратитесь к разработчику

</details><details> <summary><b>❌ .exe не запускается</b></summary>
